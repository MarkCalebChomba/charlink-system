...
<head>
    ...
    <title>Error - Charlink Connect</title>
                    ...
                    <div class="box box-danger box-solid">
                        ...
                        <div class="box-body" style="font-size: larger;">
                            ...
                            <ul>
                                ...
                                <li>{Lang::T('Make sure your Mikrotik accessible from Charlink Connect')}</li>
                            </ul>
                            {Lang::T('If you just update Charlink Connect from upload files, try click Update')} Database
                        </div>
                        <div class="box-footer">
                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                                <a href="./update.php?step=4" style="color: black;" class="btn btn-info btn-sm btn-block">{Lang::T('Update')} Database</a>
                                <a href="{Text::url('community#update')}" style="color: black;" class="btn btn-success btn-sm btn-block">{Lang::T('Update Charlink Connect')}</a>
                            </div>
                            <br>
                            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                            ...
                            class="btn btn-success btn-sm btn-block" style="color: black;">{Lang::T('Ask Github Community')}</a>
                                <a href="https://t.me/charlinkconnect" target="_blank"
