...
if($_app_stage!="Live"){
    ...
    fwrite($fh, $input);
    fclose($fh);
    $sql = file_get_contents('charlink-connect.sql');
    $qr = $dbh->exec($sql);
    if (isset($_POST['radius']) && $_POST['radius'] == 'yes') {
        ...
        <div class="span12">
            ...
            ?>
                <p> MySQL Connection was successfull. An error occured while adding data on MySQL. Unsuccessfull
                    Installation. Please refer manual installation in the website github.com/MarkCalebChomba/charlink-system/wiki or Contact Telegram @charlinkconnect  for
