        ...
        <div id="collapseGeneral" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4"><a href="https://github.com/MarkCalebChomba/charlink-system/wiki/Themes"
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <p class="help-block col-md-4"><a
                            href="https://github.com/MarkCalebChomba/charlink-system/wiki/FreeRadius"
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="github_username" name="github_username"
                                value="{$_c['github_username']}" placeholder="charlinkconnect">
                        </div>
                    </div>
                </div>
                <div class="form-group">
