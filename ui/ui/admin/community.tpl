    ...
    <div class="col-sm-6">
        ...
        <div class="box box-hovered mb20 box-primary">
            <div class="box-header">
                <h3 class="box-title">{Lang::T('Contribution')} Charlink Connect</h3>
            </div>
            <div class="box-body">
                <a href="https://github.com/MarkCalebChomba/charlink-system/graphs/contributors" target="_blank">
                    <img src="https://contrib.rocks/image?repo=MarkCalebChomba/charlink-system&columns=10" width="100%" />
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    <a href="https://github.com/MarkCalebChomba/charlink-system/discussions" target="_blank"
                        class="btn btn-primary btn-sm btn-block"><i class="ion ion-chatboxes"></i> {Lang::T('Github
                        Discussions')}</a>
                    <a href="https://t.me/charlinkconnect" target="_blank" class="btn btn-primary btn-sm btn-block"><i
...
<div class="row">
    <div class="col-sm-6">
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    <a href="https://github.com/MarkCalebChomba/charlink-system" target="_blank"
    ...
    <div class="col-sm-6">
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-body">
                {Lang::T('Your donation will help support and continue the development of Charlink Connect.')}
            </div>
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    <tbody>
...
<div class="row">
    <div class="col-sm-6">
        <div class="box box-hovered mb20 box-primary">
            ...
            <div class="box-footer">
                <a href="https://github.com/MarkCalebChomba/charlink-system" target="_blank" class="btn btn-primary btn-sm btn-block">{Lang::T('Telegram')}</a>
            </div>
        </div>
        <div class="box box-primary box-hovered mb20 activities">
            ...
            <div class="box-body">
                {Lang::T('Connect your Charlink Connect to WhatsApp efficiently using WhatsApp Gateway. Also, create Telegram bots easily and practically.')}
            </div>
            <div class="box-footer">
        ...
        <div class="box box-primary box-hovered mb20 activities">
            ...
            <div class="box-body">
                ...
                {Lang::T('is a Hotspot and PPPoE billing platform for Mikrotik developed using PHP. The application uses Mikrotik API to communicate with the router, ensuring efficient and easy integration. If you feel you get more benefits from this application, we would greatly appreciate your contribution through donation.')}<br>{Lang::T('Watch project –')} <a
                    href="https://github.com/MarkCalebChomba/charlink-system" target="_blank">{Lang::T('IN HERE')}</a>
            </div>
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <a href="https://github.com/MarkCalebChomba/charlink-system/archive/refs/heads/master.zip" target="_blank"
            ...
            <div class="box-footer">
                <div class="btn-group btn-group-justified" role="group" aria-label="...">
                    ...
                    <a href="https://github.com/MarkCalebChomba/charlink-system/blob/master/CHANGELOG.md" target="_blank"
...
<script>
    window.addEventListener('DOMContentLoaded', function() {
        ...
        $.getJSON("https://raw.githubusercontent.com/MarkCalebChomba/charlink-system/master/version.json?" + Math
            .random(),
            function(data) {
